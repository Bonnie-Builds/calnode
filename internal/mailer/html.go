...
<tr><td align="center" style="padding:18px 24px;border-bottom:1px solid #e4e4e7;text-align:center;">
{{if .LogoURL}}
...
{{else}}<span style="font-size:18px;font-weight:600;color:#18181b;">{{.Brand}}</span>{{end}}
</td></tr>
